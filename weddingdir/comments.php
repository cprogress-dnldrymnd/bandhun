...
if( is_page() ){
    ...
    ?><div id="comments" class="weddingdir-section-comment comments-area commnets-reply comments_list_wrap weddingdir-page-comment"><?php
    
}else{

    ?><div id="comments" class="weddingdir-section-comment comments-area commnets-reply comments_list_wrap weddingdir-blog-comment"><?php
}
    ...
    if ( have_comments() ) {
        ...
        ?><h3 class="fw-7 mb-4"><?php
             ...
             *  --------------------
             */
            printf( _n( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', absint( get_comments_number() ), 'weddingdir' ),
        ...
        if ( get_comment_pages_count() > absint( '1' ) && get_option( 'page_comments' ) ) { ?>
            ...
            <nav role="navigation" id="comment-nav-above" class="site-navigation comment-navigation">
                ...
                <h2 class="assistive-text"><?php esc_html_e('Comment navigation', 'weddingdir' ); ?></h2>

                <div class="weddingdir-comment-navigation">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-start">
                            ...
                            <?php
                                ...
                                previous_comments_link( esc_attr__( '&larr; Older Comments', 'weddingdir') ); 
                            ?>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-end">
                            ...
                            <?php 
                                ...
                                next_comments_link( esc_attr__('Newer Comments &rarr;', 'weddingdir') ); 
         ...
         *  -------------
         */
        ?><ol class="comments" id="weddingdir-comment-section"><?php
            ...
            wp_list_comments( array( 
                ...
                'callback'  =>  [ esc_attr( 'WeddingDir_Comment_Helper' ), esc_attr( 'weddingdir_comment' ) ],
    ...
    if ( ! comments_open() && '0' != get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ){
        ...
        printf( '<p class="nocomments">%1$s</p>', 
             ...
             *  ---------------------
             */
            esc_attr_e('Comments are closed.', 'weddingdir' )
        );
    }
    ...
    $comment_form = array(
         ...
         *  ------------------
         */
        'title_reply'               =>  esc_attr__( 'Leave a Comment', 'weddingdir' ),

        /**
         *  Translation String
         *  ------------------
         */
        'title_reply_to'            =>  esc_attr__( 'Leave a Reply to %s', 'weddingdir' ),
        ...
        'fields'                    =>  array(
            ...
            'author' => sprintf(   '<div class="col-sm-6">
                                     ...
                                     *  ---------------------
                                     */
                                    esc_attr__( 'Your Name', 'weddingdir' )
                        ),
            ...
            'email' =>  sprintf(    '<div class="col-sm-6">
                                     ...
                                     *  ---------------------
                                     */
                                    esc_attr__( 'Your Email', 'weddingdir' )
                        ),
            ...
            'cookies' =>  sprintf(  '<div class="col-12">
                                     ...
                                     *  ---------------------
                                     */
                                    esc_attr__( 'Save my name, email, and website in this browser for the next time I comment.', 'weddingdir' )
                        ),                    
        ),
        ...
        'comment_field'             =>  sprintf('<div class="col-sm-12">
                                             ...
                                             *  ------------------
                                             */
                                            esc_attr__( 'Comments', 'weddingdir' )
                                    ),
         ...
         *  ------------------
         */
        'label_submit'              =>  esc_attr__( 'Post Your Comment', 'weddingdir' ),
