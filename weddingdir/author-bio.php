...
/**
 * 	-------------------------------------
 *  WeddingDir - Author Bio Page Template
 *  -------------------------------------
 */
?>
<div class="weddingdir-section-author-bio author-wrap">
	...
	<?php
		...
		printf(    '<h3 class="author-title">
					 ...
					 *  ---------------------------
					 */
					esc_attr__( 'View All Post', 'weddingdir' )
		);
	?>
	</div>
