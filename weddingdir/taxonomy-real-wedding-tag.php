...
if( class_exists( 'WeddingDir_RealWedding' ) ) :
     ...
     *  -------------
     */
    $_taxonomy_slug     =   esc_attr( WeddingDir_Taxonomy_Database:: realwedding_tag_taxonomy() );
    ...
    if( class_exists( 'WeddingDir_Loader' ) ){
        ...
        if( $item->have_posts() ){
             ...
             *  -----------
             */
            if( WeddingDir:: _is_array( $_listing_html_data ) ){

                if( count( $_listing_html_data ) > $per_page ){
                    ...
                    foreach( $_listing_html_data as $key => $value ){
