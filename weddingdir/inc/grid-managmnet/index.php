 ...
 *  ---------------------------------
 */
if( ! class_exists( 'WeddingDir_Grid_Managment' ) && class_exists( 'WeddingDir' ) ) {

    /**
     *  WeddingDir - Page Grid Managment
     *  ---------------------------------
     */
    class WeddingDir_Grid_Managment extends WeddingDir {
        ...
        public static function page_container(){
            ...
            $_page_wrapper      =    esc_attr(  parent:: weddingdir_meta_value(
        ...
        public static function page_sidebar(){
            ...
            if( parent:: page_have_sidebar() ){
                 ...
                 *  --------------
                 */
                $_sidebar   =   esc_attr(  parent:: weddingdir_meta_value(
         ...
         *  --------------
         */
        public static function weddingdir_sidebar(){
            ...
            if( parent:: page_have_sidebar() ){
                ...
                if(  $_condition_1 && $_condition_2  ){
                     ...
                     *  -----------------------------------------
                     */
                    return      esc_attr(  parent:: weddingdir_meta_value(
                ...
                return  esc_attr( 'weddingdir-widget-primary' );
            }
        }
    }
     ...
     *  ---------------------------------
     */
    WeddingDir_Grid_Managment::get_instance();
}