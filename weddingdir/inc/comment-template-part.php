<?php
/*
 *  WeddingDir - Comment Helper
 *  ---------------------------
 */
if( ! class_exists( 'WeddingDir_Comment_Helper' ) && class_exists( 'WeddingDir' ) ){

	/*
	 *  WeddingDir - Comment Helper
	 *  ---------------------------
	 */
	class WeddingDir_Comment_Helper extends WeddingDir{
		...
		/**
		 *  3. WeddingDir - Thread Comment
		 *  ------------------------------
		 */
	    public static function weddingdir_comment( $comment, $args, $depth ) {
			...
			switch ( $comment->comment_type ) 	:
				...
				case 'pingback':
					...
					?>
					<li class="trackback"><?php esc_html_e( 'Trackback:', 'weddingdir' ); ?> <?php comment_author_link(); ?><?php edit_comment_link( esc_html__( 'Edit', 'weddingdir' ), '<span class="edit-link">', '</span>' ); ?>
					<?php
				...
				case 'trackback':
					...
					?>
					<li class="pingback"><?php esc_html_e( 'Pingback:', 'weddingdir' ); ?> <?php comment_author_link(); ?><?php edit_comment_link( esc_html__( 'Edit', 'weddingdir' ), '<span class="edit-link">', '</span>' ); ?>
					<?php
						...
						<div id="comment-<?php comment_ID(); ?>" class="comment_body comment media">
							...
							<div class="comment_author_avatar">
								...
								<div class="media-body">
										...
										<?php
											...
											comment_reply_link(
												...
												array_merge(
													...
													array( 
														...
														'reply_text' 	=> 	esc_attr__( 'Reply', 'weddingdir' ),
											...
											if( $comment->comment_approved == absint( '0' ) ){
												...
												printf( '<p><em>%1$s</em></p>',
													 ...
													 *  ---------------------------
													 */
													esc_attr__('Your comment is awaiting moderation.', 'weddingdir' )
												);
											}
									...
									<div class="weddingdir_comment_content"><?php comment_text(); ?></div>
	...
	/**
	 *  WeddingDir - Comment Helper Object
	 *  ----------------------------------
	 */
	WeddingDir_Comment_Helper::get_instance();
}